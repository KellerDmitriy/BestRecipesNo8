...
class TrendingCategoryPreviewCell: UICollectionViewCell {
    
    static let cellID = String(describing: TrendingCategoryPreviewCell.self)
    ...
    func updateRecipeData(image: UIImage?, title: String, rating: Double?) {
...
private extension TrendingCategoryPreviewCell {
